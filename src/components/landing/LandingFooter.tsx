    ...
    <footer className="border-t border-border bg-muted/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          <div className="col-span-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-xs mb-5">
              The premium fitness platform for people who take their health seriously.
            </p>
            <div className="flex items-center gap-3">
              {socials.map(({ Icon, label, href }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="w-9 h-9 rounded-lg border border-border bg-background flex items-center justify-center hover:bg-accent hover:border-brand-300 transition-colors text-muted-foreground hover:text-foreground"
                >
                  <Icon />
                </a>
              ))}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-muted-foreground">Made with ❤️ for the fitness community</p>
        </div>
      </div>
    </footer>
  );
